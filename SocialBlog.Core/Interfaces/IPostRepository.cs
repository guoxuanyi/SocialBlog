...
namespace SocialBlog.Core.Interfaces
{
    public interface IPostRepository
    {
        ...
        Task<List<Post>> GetTrashByAuthorIdAsync(string authorId, int skip = 0, int limit = 10, CancellationToken cancellationToken = default);
        ...
        Task<long> CountTrashByAuthorIdAsync(string authorId, CancellationToken cancellationToken = default);
